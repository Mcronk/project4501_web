...
def courseList(request):
	...
	#context_dict = resp
	context_dict = [{'name': 'vainglory', 'course_tutor': 'johnson', 'price': '333', 'description': 'Teach you how to be a master in vainglory in three classes, each with 60 minutes.'},{'name': 'vainglory', 'course_tutor': 'johnson', 'price': '333', 'description': 'Teach you how to be a master in vainglory in three classes, each with 60 minutes.'}]
